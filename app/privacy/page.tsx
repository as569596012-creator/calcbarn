...
export const metadata: Metadata = buildMetadata({
  ...
  description: `How ${SITE_NAME} handles your data. Calculations run in your browser; we do not collect personal information.`,
  path: "/privacy/",
});
...
export default function PrivacyPage() {
  return (
    <article className="prose-tool mx-auto max-w-3xl px-4 py-12">
      ...
      <h2 className="mt-8 text-xl font-bold text-gray-900">Calculations stay in your browser</h2>
      <p className="mt-3">
        Every calculator on {SITE_NAME} runs entirely in your web browser. The numbers you enter
      ...
      <p className="mt-3">
        ...
        anonymous, aggregated usage statistics (such as page views and which calculators are
        popular) to improve the site.
      </p>
